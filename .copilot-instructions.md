# Copilot Instructions - Zone Heater Manager
...
zone_heater_manager/
├── custom_components/
│   └── smart_heating/           # Main integration directory
...
├── sync.sh                      # **WRONG NAME - Actually synch.sh**
├── synch.sh                     # **CORRECT** - Quick sync to test container
...
**⚠️ IMPORTANT: Script names are confusing!**

1. **`synch.sh`** (note the 'h') - **Primary development script**
   - Quick sync for iterative development
   - Builds frontend automatically
   - Copies all files to test container
...
**Current Version:** v0.3.1 (committed)
**Next Version:** v0.3.2 (in progress - adding v0.3.0 features to frontend UI)
...
# Or use synch.sh which does this automatically
```
...
**Next Version:** v0.3.2 (adding v0.3.0 frontend UI)
